let name = "Tyler Hawk"; // Define a string here, e.g., "Juan Cruz"
let age = 19; // Define a number here, e.g., 30
let isStudent = false; // Define a boolean here, e.g., true or false
let hobbies = "Photography"; // Define an array here, e.g., ["reading", "gaming", "coding"]
...
const favoriteBooks = "Hunger Games"; // Define an array here, e.g., ["1984", "Brave New World", "Fahrenheit 451"]
...
// Using var
var city = "California"; // Define a string here, e.g., "New York"
var temperature = 33.6; // Define a number here, e.g., 22.5
var hasPets = true; // Define a boolean here, e.g., true or false
var colors = ["Red", "Blue", "Green"]; // Define an array here, e.g., ["red", "green", "blue"]
